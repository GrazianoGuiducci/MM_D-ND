#!/usr/bin/env python3
"""
md_to_site_G.py — Convert Paper G draft to site-ready format for d-nd.com
...
def extract_metadata(content: str) -> dict:
    metadata = {
        ...
        "paper_id": "G", "paper_label": "Paper G",
...
def main():
    print("=" * 60)
    print("Paper G → Site-Ready Conversion")
    print("=" * 60)
    source_file = INPUT_DIR / "paper_G_draft3.md"
