#!/usr/bin/env python3
"""
md_to_site_D.py — Convert Paper D draft to site-ready format for d-nd.com
...
def main():
    print("=" * 60)
    print("Paper D → Site-Ready Conversion")
    print("=" * 60)

    # Read source
    source_file = INPUT_DIR / "paper_D_draft2.md"
    ...
    # Save metadata
    meta_file = OUTPUT_DIR / "paper_D_metadata.json"
    ...
    site_file = OUTPUT_DIR / "paper_D.md"
    ...
    print(f"Files:")
    for f in sorted(OUTPUT_DIR.rglob("paper_D*")):
        if f.is_file():
            size = f.stat().st_size
