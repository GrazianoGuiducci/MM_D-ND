...
triggers: [osserva, monitora, controlla, verifica stato]
---
...
Scopo: Osservare un contesto, generare domande socratice e scegliere la **Forma Espressiva** migliore per l'output.
...
**Fase 0 – Posizionamento**: Stabilire l’intento primario (`Φ₀`).
...
**Fase 4 – Feedback e retroazione**: Collasso del campo con Morpheus e analisi dello scarto.
