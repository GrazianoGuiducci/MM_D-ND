#!/usr/bin/env python3
"""
md_to_site_E.py — Convert Paper E draft to site-ready format for d-nd.com
...
def extract_metadata(content: str) -> dict:
    metadata = {
        ...
        "paper_id": "E", "paper_label": "Paper E",
...
def main():
    print("=" * 60)
    print("Paper E → Site-Ready Conversion")
    print("=" * 60)
    source_file = INPUT_DIR / "paper_E_draft3.md"
