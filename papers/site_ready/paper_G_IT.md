...
| **Emergenza temporale D-ND (Paper E)** | Oscillazione dipolare cosmica | Divergenza (anti-gravità, t < 0) | Convergenza (gravità, t > 0) | Asimmetria temporale tramite rotazione del dipolo | Congetturato: Ω_NT = 2πi (congettura motivata, Paper A §5.5) | La freccia del tempo emerge dalla fase del dipolo | Richiede materia esotica (espansione accelerata) |
